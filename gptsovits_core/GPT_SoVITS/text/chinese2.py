...
if is_g2pw:
    ...
    # g2pw = G2PWPinyin(model_dir="GPT_SoVITS/text/G2PWModel",model_source="Models_Pretrained\pretrained_models\chinese-roberta-wwm-ext-large",v_to_u=False, neutral_tone_with_five=True)
    g2pw = G2PWPinyin(model_dir="Models_Pretrained\pretrained_models\G2PWModel",model_source="Models_Pretrained\pretrained_models\chinese-roberta-wwm-ext-large",v_to_u=False, neutral_tone_with_five=True)
